        ...
        <TabsContent value="summary" className="flex-1 overflow-auto custom-scrollbar m-0 p-4">
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xs text-muted-foreground uppercase tracking-wide">Document Summary</span>
              <Button variant="ghost" size="icon" className="h-6 w-6" title="Copy summary">
            ...
            <div className="pt-4 border-t border-border">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span>Generated by Advyon AI • Last updated just now</span>
              </div>
            </div>
          </motion.div>
        </TabsContent>
